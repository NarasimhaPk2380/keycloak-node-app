...
describe("UsersController success cases", function () {
    var usersController;
...
describe("UsersController failure cases", function () {
    var usersController;
    // const OktaClientServiceMock = <jest.Mock<OktaClientService>>OktaClientService;
    // const instanceOfOktaClientServiceMock = new OktaClientServiceMock(
    //   oktaClient,
    ...
    it("Should throw error while creating user", function () { return __awaiter(void 0, void 0, void 0, function () {
        var res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
